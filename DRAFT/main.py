...
def run_matching(cv_path, job_path, n_runs=5):
    ...
    for i in range(n_runs):
        ...
        scores, cv_structured, job_structured, cv_text, job_text = single_run(
            cv_path, job_path
        )
    ...
    return {
        ...
        "scores_std": stability,
        "explanation": explanation,
        "cv_structured": last_cv_structured,
        "job_structured": last_job_structured,
        "cv_full_text": last_cv_text[:800],
        "job_full_text": last_job_text[:800],
        "n_runs": n_runs
    }
